...
import Footer from "../../components/shared/footer/FooterPolicy";
import ScrollToTop from "../../components/scroll-to-top";
import { LayoutTypes } from "@/domains/types/device.type";
...
const VerticalPolicyLayout = (props: LayoutProps) => {
...
export default VerticalPolicyLayout;
