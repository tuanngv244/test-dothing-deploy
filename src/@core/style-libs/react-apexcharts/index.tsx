...
const ApexChartWrapper = styled('div')(({ theme }) => ({
  '& .apexcharts-canvas': {
    ...
    '& .apexcharts-xaxistooltip': {
      borderColor: theme.palette.divider,
      background: (theme: any) => theme.palette.mode === 'light' ? theme.palette.grey[50] : theme.palette.customColors.bodyBg,
      '& .apexcharts-xaxistooltip-text': {
        color: theme.palette.text.primary
      },
      '&:after': {
        borderBottomColor: (theme: any) => theme.palette.mode === 'light' ? theme.palette.grey[50] : theme.palette.customColors.bodyBg
      },
      '&:before': {
    ...
    '& .apexcharts-yaxistooltip': {
      ...
      '&:after': {
        borderLeftColor: (theme: any) => theme.palette.mode === 'light' ? theme.palette.grey[50] : theme.palette.customColors.bodyBg
      },
      '&:before': {
    ...
    '& .apexcharts-heatmap-rect': {
      stroke: (theme: any) => theme.palette.mode === 'light' ? theme.palette.background.paper : theme.palette.customColors.bodyBg
    },
    '& .apexcharts-radialbar > g > g:first-of-type .apexcharts-radialbar-area': {
      stroke: (theme: any) => theme.palette.customColors.bodyBg
    },
